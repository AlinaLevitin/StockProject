...
model = tf.keras.models.Sequential([
    ...
    tf.keras.layers.Dense(config.neurons, activation='elu'),
...
model.fit(data.x_train, data.y_train, epochs=config.epochs, validation_data=(data.x_val, data.y_val), batch_size=config.batch_size)
